...
def main():
    ...
    jobs_dir = Path("./experiments/mnist_job_scripts")
...
"""
    ...
    for i, job_file in enumerate(job_files, 1):
        ...
        master_script += f"sbatch experiments/mnist_job_scripts/{job_file}\n"
...
"""
    ...
    print(f"   bash experiments/mnist_job_scripts/mnist_quantum_hydra_seed2024.sh")
    print()
    print("3. Monitor progress:")
    print(f"   tail -f experiments/mnist_results/logs/*.log")
    print()
    print("4. After completion, aggregate results:")
    print(f"   python experiments/aggregate_mnist_results.py")
    print("="*80)
