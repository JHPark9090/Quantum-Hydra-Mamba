#!/bin/bash
#SBATCH --job-name=gated_enhancers_cohn
...
#SBATCH --array=0-9
#SBATCH --output=/pscratch/sd/j/junghoon/quantum_hydra_mamba/results/genomic/logs/gated_enhancers_cohn_%a.log
#SBATCH --error=/pscratch/sd/j/junghoon/quantum_hydra_mamba/results/genomic/logs/gated_enhancers_cohn_%a.log
